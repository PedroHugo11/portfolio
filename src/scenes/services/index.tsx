  ...
  return (
    <Container id="services">
      <ContentContainer>
        ...
        <SubTitle>
        Over the past 8 years of learning many languages and coding in dev teams, in the last year i have been moving towards the goal of becoming a senior developer, always learning new stuff and challenging myself in new projects. (Hover your mouse over the images).  
        </SubTitle>
        <ImageContainer>
        <HtmlTooltip
          title={
          ...
          title={
            <React.Fragment>
              ...
              <b>{'Intermediate'}</b> <u>{'About Postgres DB:'}</u>{' '}
          ...
          title={
            <React.Fragment>
              ...
              <b>{'Intermediate'}</b> <u>{'About GIT:'}</u>{' '}
          ...
          title={
            <React.Fragment>
              ...
              <b>{'Advanced'}</b> <u>{'About Photoshop:'}</u>{' '}
